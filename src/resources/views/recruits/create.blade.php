            ...
            <div class="flex flex-wrap items-center justify-center">
                <div class="form-content">
                    ...
                    <form method="POST" action="{{ route('recruit.store') }}">
                        ...
                        <!--
                        <div class="relative mb-4">
                            <label for="capacity" class="leading-7 text-sm text-gray-600">募集人数</label>
                            <input type="number" name="capacity" id="capacity" class="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" required>
                        </div>
                        -->
